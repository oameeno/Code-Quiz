...
var questionsObject = { // Object that holds correct answers.
    correct: {
        ...
        1: "The condition statement if/else statement is enclosed with?:",
        2: "Arrays in JavaScript can be used to store", // Button #4 for 
        3: "String values must be enclosed within ____ when being assigned to variables", // Button #3
